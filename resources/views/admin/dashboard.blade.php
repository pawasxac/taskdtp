...
<!-- Section Header -->
<div class="premium-section-header stagger-item stagger-1">
...
<div class="premium-grid cols-4">
    <div class="premium-stat stagger-item stagger-2">
        <h4>☕ Coffee Shops</h4>
        <p>{{ \App\Models\CoffeeShop::count() }}</p>
    </div>

    <div class="premium-stat secondary stagger-item stagger-3">
        <h4>👥 Total Users</h4>
        <p>{{ \App\Models\User::count() }}</p>
    </div>

    <div class="premium-stat accent stagger-item stagger-4">
        <h4>🏘️ Komunitas</h4>
        <p>{{ \App\Models\Komunitas::count() }}</p>
    </div>

    <div class="premium-stat stagger-item stagger-5">
        <h4>⭐ Avg Rating</h4>
        <p>{{ number_format(\App\Models\CoffeeShop::avg('rating'), 1) ?? 0 }}/5</p>
    </div>

    <div class="premium-stat secondary stagger-item stagger-6">
        <h4>💬 Reviews</h4>
        <p>{{ \App\Models\CoffeeShopReview::count() }}</p>
    </div>

    <div class="premium-stat accent stagger-item stagger-7">
        <h4>🤝 Anggota Komunitas</h4>
        <p>{{ \App\Models\CommunityMember::count() }}</p>
    </div>

    <div class="premium-stat stagger-item stagger-8">
        <h4>📝 Community Posts</h4>
        <p>{{ \App\Models\CommunityPost::count() }}</p>
    </div>

    <div class="premium-stat secondary stagger-item stagger-8">
...
<div class="premium-section-header mt-48 mb-24 stagger-item stagger-1">
    <h2>Pusat Kontrol</h2>
...
<div class="premium-action-menu">
    <a href="{{ route('coffee.index') }}" class="premium-action-card stagger-item stagger-2">
        <h3>☕ Coffee Shops</h3>
        <p>Kelola data kedai kopi dengan informasi lengkap, lokasi, tingkat kebisingan, dan deskripsi</p>
    </a>

    <a href="{{ route('komunitas.index') }}" class="premium-action-card stagger-item stagger-3">
        <h3>🏘️ Komunitas</h3>
        <p>Kelola komunitas, anggota, dan struktur organisasi komunitas</p>
    </a>

    <a href="{{ route('community-posts.index') }}" class="premium-action-card stagger-item stagger-4">
        <h3>📝 Community Posts</h3>
        <p>Moderasi dan kelola postingan komunitas untuk menjaga kualitas konten</p>
    </a>

    <a href="{{ route('gathering-requests.index') }}" class="premium-action-card stagger-item stagger-5">
        <h3>🎯 Gathering Requests</h3>
        <p>Kelola permintaan dan penjadwalan event gathering komunitas</p>
    </a>

    <a href="{{ route('coffee-shop-reviews.index') }}" class="premium-action-card stagger-item stagger-6">
        <h3>⭐ Reviews</h3>
        <p>Monitor dan kelola review coffee shop dari pengguna</p>
    </a>

    <a href="{{ route('admin.login.monitor') }}" class="premium-action-card stagger-item stagger-7">
        <h3>👤 User Management</h3>
        <p>Kelola akun user, role, permission, dan aktivitas login</p>
    </a>

    <a href="{{ route('kecamatan.index') }}" class="premium-action-card stagger-item stagger-8">
        <h3>📍 Kecamatan</h3>
        <p>Kelola data wilayah dan distribusi geografis platform</p>
    </a>

    <a href="{{ route('community-members.index') }}" class="premium-action-card stagger-item stagger-8">
...
<div class="premium-grid cols-2">
    <div class="premium-card stagger-item stagger-2">
    ...
    <div class="premium-card stagger-item stagger-3">
...
<div class="premium-grid cols-3">
    <div class="premium-card stagger-item stagger-2">
        ...
        <p class="stat-label">Rasio postingan terhadap pengguna</p>
    </div>
    ...
    <div class="premium-card stagger-item stagger-3">
        ...
        <p class="stat-label">dari {{ $totalShops }} coffee shops</p>
    </div>

    <div class="premium-card stagger-item stagger-4">
        ...
        <p class="stat-label">member per komunitas</p>
    </div>
</div>
...
<div class="premium-action-menu">
    <div class="premium-action-card disabled stagger-item stagger-2">
...
<!-- Footer Card -->
<div class="premium-card mt-48 stagger-item stagger-8" style="background: linear-gradient(135deg, rgba(139, 111, 71, 0.08) 0%, rgba(200, 168, 120, 0.04) 100%);">
